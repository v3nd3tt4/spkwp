	...
	<nav class="navbar navbar-default navbar-static-top">
	  <div class="container">
		...
		<div class="navbar-header">
		  ...
		  <a class="navbar-brand" href="http://www.codeberkas.xyz">Sistem Penunjang Keputusan "WP (Weighted Product)"</a>
		</div>

		<!-- Collect the nav links, forms, and other content for toggling -->
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		  <ul class="nav navbar-nav navbar-right">
			<li><a href="http://www.codeberkas.xyz">KELOMPOK 9</a></li>
		  </ul>
		</div><!-- /.navbar-collapse -->
	  </div><!-- /.container-fluid -->
	</nav>
		...
		<div class="row">
		  ...
		  <div class="col-xs-12 col-sm-4 col-md-4">
		  	...
		  	<div style="margin-top: 100px;" class="panel panel-default"><div class="panel-body">
				  ...
				  <p><small style="color:#999;">Masukkan Username dan Password</small></p>
